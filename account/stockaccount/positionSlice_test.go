...
func TestUpdateWithOrder(t *testing.T) {
	...
	so1 := order.NewStockOrder(instID, true, false, "2022-05-10 14:52", 8.5, 2.0, "Buy", &scp)
	...
	so2 := order.NewStockOrder(instID, true, false, "2022-05-10 14:53", 9.5, 2.0, "Buy", &scp)
	...
	so3 := order.NewStockOrder("SZ000058", true, false, "2022-05-11 14:54", 8.0, 3.0, "Sell", &scp)
