...
func (sortbuy *SortBuyStrategy) ActOnData(datetime string, bc *dataprocessor.BarC, vAcct *virtualaccount.VAcct, CPMap contractproperty.CPMap, Eval func([]float64) []float64) (orderRes OrderResult) {
	return orderRes
}
